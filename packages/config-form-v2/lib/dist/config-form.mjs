...
var render$1 = function() {
  ...
  }, "component", Object.assign({}, _vm.defaultProps["form"], _vm.$attrs), false), [_vm._t("default", function() {
    return [_vm._l(_vm.formItems, function(formItem) {
      var _formItem$componentPr;
      return [(typeof formItem.hidden === "function" ? !formItem.hidden(_vm.model) : !formItem.hidden) ? _c(_vm.componentMaps["formItem"] || "el-form-item", _vm._b({
        key: formItem.prop,
        tag: "component",
        attrs: {
          "prop": formItem.prop,
      ...
      }, "component", Object.assign({}, _vm.defaultProps["formItem"], formItem.formItemProps), false), [_vm.$slots["".concat(formItem.prop, "-label")] ? _c("template", {
        slot: "label"
      }, [_vm._t("".concat(formItem.prop, "-label"), function() {
        return [_vm._v(_vm._s(formItem.label))];
      })], 2) : _vm._e(), _vm.$slots["".concat(formItem.prop)] ? [_vm._t("".concat(formItem.prop))] : _c(typeof formItem.component === "string" ? _vm.componentMaps[formItem.component] : formItem.component, _vm._g(_vm._b({
        tag: "component",
        attrs: {
          "disabled": typeof formItem.disabled === "function" ? formItem.disabled(_vm.model) : !!formItem.disabled || ((_formItem$componentPr = formItem.componentProps) === null || _formItem$componentPr === void 0 ? void 0 : _formItem$componentPr.disabled)
        },
        model: {
          value: _vm.model[formItem.prop],
          callback: function($$v) {
            _vm.$set(_vm.model, formItem.prop, $$v);
          },
          expression: "model[formItem.prop]"
        }
      }, "component", Object.assign({}, typeof formItem.component === "string" ? _vm.defaultProps[formItem.component] : {}, formItem.componentProps), false), formItem.componentEvents))], 2) : _vm._e()];
    })];
  })], 2);
};
...
const ConfigForm = /* @__PURE__ */ function() {
...
var render = function() {
  ...
  var _h = _vm.$createElement;
  var _c = _vm._self._c || _h;
  return _vm.formItem ? _c(_vm.componentMaps["formItem"], {
    tag: "component",
    attrs: {
      "prop": _vm.prop,
      "label": _vm.formItem.label
    }
  }, [_c("template", {
    slot: "label"
  }, [_vm._t("label", function() {
    return [_vm._v(_vm._s(_vm.formItem.label))];
  })], 2), _vm._t("default", function() {
    return [_c(typeof _vm.formItem.component === "string" ? _vm.componentMaps[_vm.formItem.component] : _vm.formItem.component, _vm._g(_vm._b({
      tag: "component",
      attrs: {
        "disabled": typeof _vm.formItem.disabled === "function" ? _vm.formItem.disabled(_vm.model) : !!_vm.formItem.disabled
      },
      model: {
        value: _vm.model[_vm.formItem.prop],
        callback: function($$v) {
          _vm.$set(_vm.model, _vm.formItem.prop, $$v);
        },
        expression: "model[formItem.prop]"
      }
    }, "component", Object.assign({}, typeof _vm.formItem.component === "string" ? _vm.defaultProps[_vm.formItem.component] : {}, _vm.formItem.componentProps), false), _vm.formItem.componentEvents))];
  })], 2) : _vm._e();
};
var staticRenderFns = [];
const __vue2_script = {
...
const ConfigFormItem = /* @__PURE__ */ function() {
